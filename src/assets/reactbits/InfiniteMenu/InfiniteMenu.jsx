    ...
    Promise.all(this.items.map(item =>
      new Promise(resolve => {
        try {
          ...
          // defaultimg.onload = () => resolve(img);
          // defaultimg.src = 'https://images.pexels.com/photos/167092/pexels-photo-167092.jpeg';
...
export default function InfiniteMenu({ items = [] }) {
  ...
  const handleButtonClick = () => {
    if (!activeItem?.link) return;
      ...
      navigate(`/movie/${Math.round(activeItem.link)}`);
    }
  };

  let bgDefault = 'https://images.pexels.com/photos/247676/pexels-photo-247676.jpeg'
  const [bgImg, setBgImg] = useState(bgDefault)
