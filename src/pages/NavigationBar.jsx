  ...
  return (
    <>
        ...
        <div class='absolute top-0 left-0 w-full h-[6em] z-2 bg-gradient-to-b from-black to-black/45 flex items-center justify-center'>
            ...
            <input type='text' style={{userSelect: 'none'}} onChange={(e) => {searchQuery(e.target.value)}} className=' w-[70%] h-[3em] p-4 z-30 bg-black-950/50 rounded-3xl text-slate-300 ring-2 shadow-2xl shadow-amber-50 md:w-[60%]' placeholder='Search'></input>
        </div>      
        <Outlet />
    </>
